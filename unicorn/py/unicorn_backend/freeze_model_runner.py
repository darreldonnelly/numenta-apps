...
def generateZipIncludes(base_path, directory_name):
  """
...
def main():
  ...
  includeFiles = []
  includeFiles.append((pyproj.pyproj_datadir, os.path.join("pyproj", "data")))
  includeFiles.append((os.path.join(modelRunnerDir, "stats_schema.json"),
                       "stats_schema.json"))
  ...
  freezer = cx_Freeze.Freezer(executables,
                              namespacePackages=["nupic", "pkg_resources"],
